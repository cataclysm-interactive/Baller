...
namespace DeltaDNA
{
    ...
    static class ClientInfo
    {
        ...
        private static string GetCurrentTimezoneOffset() {
            ...
            if (!retrieved) {
                try {
                    // GameGrowth update: TimeZone is obsolete but used as a fallback here for the new TimeZoneInfo that could fail, thus removing warning as the use is on purpose.
